...
alter table public.labor_rates add column if not exists title text;
alter table public.materials add column if not exists title text;
alter table public.assemblies add column if not exists title text;
alter table public.templates add column if not exists title text;
alter table public.project_type_templates add column if not exists title text;
...
drop policy if exists "Users manage own rows" on public.labor_rates;
create policy "Users manage own rows" on public.labor_rates for all using (auth.uid() = user_id) with check (auth.uid() = user_id);
drop policy if exists "Users manage own rows" on public.materials;
create policy "Users manage own rows" on public.materials for all using (auth.uid() = user_id) with check (auth.uid() = user_id);
drop policy if exists "Users manage own rows" on public.assemblies;
create policy "Users manage own rows" on public.assemblies for all using (auth.uid() = user_id) with check (auth.uid() = user_id);
drop policy if exists "Users manage own rows" on public.templates;
create policy "Users manage own rows" on public.templates for all using (auth.uid() = user_id) with check (auth.uid() = user_id);
drop policy if exists "Users manage own rows" on public.project_type_templates;
create policy "Users manage own rows" on public.project_type_templates for all using (auth.uid() = user_id) with check (auth.uid() = user_id);
